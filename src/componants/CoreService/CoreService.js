                    ...
                    <Col lg={5}>
                        <Row >
                            ...
                            <Col lg={6}>
                                ...
                                <Button variant="secondary mb-1"><span className="text-danger"><i className="fas fa-angle-double-right"></i></span> Talented Cardiologist</Button> <br />
                                <Button variant="secondary mb-1"><span className="text-danger"><i className="fas fa-angle-double-right"></i></span> High Tech Equipments</Button> <br />
                                <Button variant="secondary mb-1"><span className="text-danger"><i className="fas fa-angle-double-right"></i></span> Personalized Care</Button> <br />
                            </Col>
                        </Row>
                    </Col>
